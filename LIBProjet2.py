...
def inverse(A): #n�c�ssite prodmatscal et transpose
...
def carrevide(n, a):
    ...
    for i in range(p):
        ...
        W.append([-c, y, 0])
        W.append([c, y, 0])
    return transpose(W[:n])  # au cas o� d�passe

# Question 4 : Carr� plein
def carreplein(n, a):
    W = []
    c = a / 2
    k = int(n**0.5)
